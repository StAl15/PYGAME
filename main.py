...
pygame.display.set_caption("Крестики-нолики") #заголовок
screen.fill((255, 255, 255))

#значения поля на старте
field = [["", "", ""],
         ["", "", ""],
         ["", "", ""]]
mainloop = True
...
while mainloop:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not game_over:
            ...
            #заполняем сетку значениями при клике
            ...
            #проверка на победу при текущих значениях на поле
